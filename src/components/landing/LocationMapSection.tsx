...
export function LocationMapSection() {
  ...
  return (
    <section id="ubicacion" className="py-16 px-4 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors">
      <div className="max-w-[1220px] mx-auto space-y-10">
        {/* Encabezado */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-100 dark:bg-blue-950/60 text-blue-900 dark:text-blue-300 border border-blue-200 dark:border-blue-900/60">
          ...
          <div className="flex flex-wrap items-center gap-2.5 self-start md:self-auto">
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-[#0d233a] hover:bg-[#163b5c] dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-slate-950 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition shadow-sm"
            >
              <Navigation className="w-3.5 h-3.5 text-amber-400 dark:text-slate-950" />
              <span>Abrir en Google Maps</span>
              <ExternalLink className="w-3 h-3 text-slate-400 dark:text-slate-900" />
            </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 bg-slate-100 dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-300 dark:border-slate-800 shadow-md relative flex flex-col min-h-[380px] sm:min-h-[440px]">
            {/* Cabecera del visor del mapa */}
            <div className="bg-[#0d233a] dark:bg-slate-900 text-white px-4 py-2.5 flex items-center justify-between text-xs font-semibold border-b border-slate-800">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200/90 dark:border-amber-900/50 rounded-2xl p-4 sm:p-5 space-y-2 text-xs">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-blue-100 dark:bg-blue-950/60 text-blue-800 dark:text-blue-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Navigation className="w-4 h-4" />
                </div>
                <div className="space-y-0.5 text-xs">
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Vialidades principales</h4>
              ...
              <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Bus className="w-4 h-4" />
                </div>
                <div className="space-y-0.5 text-xs">
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Transporte público</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-amber-100 dark:bg-amber-950/60 text-amber-900 dark:text-amber-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <GraduationCap className="w-4 h-4" />
                </div>
                <div className="space-y-0.5 text-xs">
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Escuelas y comercios locales</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              {/* 4. Empleo */}
              <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-purple-100 dark:bg-purple-950/60 text-purple-800 dark:text-purple-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Building2 className="w-4 h-4" />
                </div>
                <div className="space-y-0.5 text-xs">
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Centros de trabajo y parques industriales</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
